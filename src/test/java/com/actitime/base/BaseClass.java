...
public class BaseClass implements ITestListener{
	...
	public static void writeErrorLogs(Throwable t)
	{
		...
		logger.error(s1);
		elogger.log(Status.WARNING, "The test case Failed the exception captured is "+s1);
	...
	public static void captureScreenShotOnFailure(String fileName) throws IOException
	{
		...
		//Capturing Screenshot in capture screenshot method
		elogger.fail(fileName,MediaEntityBuilder.createScreenCaptureFromPath(destFile.getAbsolutePath()).build());
	...
	public void onTestStart(ITestResult result) {	
		File f2 = new File("./src/test/results/eresults.html");
		reporter = new ExtentSparkReporter(f2);
	...
	public void onTestSuccess(ITestResult result) {	
		try {
			...
			elogger.log(Status.PASS, "The Test case by name "+result.getName()+" is Passed");
	...
	public void onTestFailure(ITestResult result) {
		try {			
			...
			elogger.log(Status.FAIL, "The Test case by name "+result.getName()+" is Failed");
